...
def postprocess_predictions(model_outputs: dict) -> dict:
    """
    ...
    decodes class predictions and computes confidence scores.
    """
    # Crop Type
    ...
    stress_probs = torch.softmax(stress_logits, dim=1)[0]
